...
<body
      background="${pageContext.request.contextPath}/images/alex-padurariu.jpg">
    <div align="center">
        <table border="0" width="1140px" cellspacing="0" cellpadding="0" id="table1">
            ...
            <tr>
                <td background="${pageContext.request.contextPath}/images/submarine.jpg" width="740" height="412"></td>
                <td class="login_msg" width="400" align="center">
                    <!-- margin:0px auto; 控制当前标签居中-->
                    <fileset style="width: auto; margin: 0px auto;">
                        <legend>
